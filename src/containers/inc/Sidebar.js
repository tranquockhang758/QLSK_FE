...
// import images from "../../../src/assets/images/zzz.jpg";
...
class Sidebar extends Component {
  ...
  render() {
    const { thumbnail, userInfo } = this.props;
    return (
      <>
        <div>
          <>
            ...
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
              ...
              <div className="sidebar">
                ...
                <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                  <div className="image-thumbnail-admin">
                    <img
                      src={
                        "https://github.com/tranquockhang758/upload-image/assets/81581623/0e7d6a3d-4424-4ce0-a7f5-e9087c95788b"
                      }
